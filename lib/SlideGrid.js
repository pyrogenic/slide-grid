    ...
    function SlideGrid(props) {
        ...
        _this.onMouseOrTouchDown = function (event) {
            ...
            if (target) {
                ...
                console.log({ touching: touching_1 });
                _this.setState({
                    active: target,
        ...
        _this.onMouseOrTouchMove = function (event, onlyUpdateActive) {
            ...
            console.log({ touchCount: event.touchCount, wiggle: _this.state.wiggle });
            ...
            if (canDrag) {
                ...
                if (isDragging) {
                    ...
                    var newTransform = "translate(" + dx + "px," + dy + "px) " + DRAGGING_STYLE_TRANSFORM;
                    ...
                    if (target) {
                        ...
                        var _loop_1 = function () {
                            ...
                            exchangeTarget.style.transition = "all " + _this.tuning.slideDurationMS + "ms ease-in-out";
                            var a = active.id;
            ...
            else if (target && _this.props.smear) { // touching something
        ...
        var tuning = __assign({}, DEFAULT_TUNING, props.tuning);
        _this.state = { tuning: tuning };
