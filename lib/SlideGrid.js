...
var SlideGrid = /** @class */ (function (_super) {
    ...
    function SlideGrid(props) {
        ...
        _this.exchange = function (a, b) {
            ...
            console.log("exchange(".concat(a, ", ").concat(b, ")"));
            exchange(a, b);
        };
        ...
        _this.onMouseOrTouchDown = function (event) {
            ...
            if (target) {
                ...
                var targetParentX = target.parentElement.offsetLeft;
                var targetParentY = target.parentElement.offsetTop;
                var emptyLocation = {
                    left: rect.left,
                    top: rect.top,
        ...
        _this.onMouseOrTouchMove = function (event, onlyUpdateActive) {
            ...
            if (!active || !activeLocation) {
                console.log({ active: active, activeLocation: activeLocation });
                return;
            }
        ...
        _this.recordTouch = function (kind, event) {
            ...
            clientY /= touchCount;
            var target = event.target;
            if (_this.lastInputEvent) {
                if (_this.lastInputEvent.kind !== "up") {
                    target = _this.lastInputEvent.target;
                }
            }
            if (kind === "down" && target === _this.myDomElement) {
                target = (_a = _this.childElements.find(function (e) {
                    if (!e.parentElement) {
                        return false;
                    }
                    ...
                    return false;
                })) !== null && _a !== void 0 ? _a : target;
                console.log("recordTouch: found actual target to cache: ".concat(target.id));
            }
            console.log("recordTouch: ".concat(kind, " on ").concat(event.target.id, " ==> ").concat(target.id));
            _this.lastInputEvent = { kind: kind, target: target, clientX: clientX, clientY: clientY, touchCount: touchCount };
    ...
    SlideGrid.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if (active && location && emptyLocation && active.classList.contains(DRAGGING)) {
            ...
            var activeParentX = active.parentElement.offsetLeft;
            var activeParentY = active.parentElement.offsetTop;
